...
cor1= "#221822" #preto meio rosa
cor2 = "#e3e3e3" #quasd branco 
cor3 = "#fdd9ff" #rosa claro
cor4 = "#d9ffef" #verde claro
cor5 = "#feffd9" #amarelo claro
...
justify=RIGHT, font=('Ivy 18'),bg=cor2, fg=cor1)
...
b_3= Button(frame_corpo,command=lambda:entrada_valores('/'), text="/", width=5, height=2, bg= cor3, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_7= Button(frame_corpo,command=lambda:entrada_valores('*'), text="*", width=5, height=2, bg= cor3, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_11= Button(frame_corpo,command=lambda:entrada_valores('-'), text="-", width=5, height=2, bg= cor3, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_15= Button(frame_corpo,command=lambda:entrada_valores('+'), text="+", width=5, height=2, bg= cor3, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_18= Button(frame_corpo,command=calcular, text="=", width=5, height=2, bg= cor3, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
